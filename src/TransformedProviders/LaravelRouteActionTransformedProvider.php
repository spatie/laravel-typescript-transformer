...
use Spatie\LaravelTypeScriptTransformer\References\LaravelRouteActionReference;
...
class LaravelRouteActionTransformedProvider extends LaravelRouteTransformedProvider
{
    /**
